...
public class AnswerController {
    ...
    /**
     * Page de recherche QAnswer (version Spring)
     */
    @RequestMapping("/")
    ...
    /**
     * Page de recherche QAnswer (version Javascript)
     */
    ...
    public String botdisplayentreprise(Model m, Bot b) throws LoginFailedException, MediaWikiApiErrorException, IOException {
        String label = b.getLabel();
        String code = b.getCode();
        String lang = b.getLang();
        boolean type = b.isTranscription();
